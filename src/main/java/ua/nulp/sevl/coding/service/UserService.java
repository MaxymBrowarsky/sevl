...
public interface UserService {
    void createUser(String name, String surname, String login, String password, Set<Role> roles, Set<Attempt> attempts);
    void save(String name, String surname, String login, String password, Set<Role> roles, Set<Attempt> attempts);
    void save(User user);
    void delete(Long id);
